...
// REMOVE or COMMENT OUT these lines — they destroy the session cookie:
...
$sql = "SELECT product.Product_ID, product.Name, product.description, image.Image_URL 
        ...
        WHERE category.Name = 'Floral Perfumes' AND image.Is_Main_Image = 1;";
...
<head>
    ...
    <title>AU-RA | Floral Perfumes</title>
...
?>)
    ...
    <div class="video-cover-container">
        <video autoplay muted loop class="video-cover">
            <source src="images/floral video.mp4" type="video/mp4">
...
<!-- Floral Perfumes Collection Section -->
<div class="background-image-container">
    <h1 class="page-title">Bestsellers's Floral Perfumes</h1>
